...
export default function Header() {
  return (
    <header>
		<nav className="container p-6 flex-ac justify-between">
			<a href="">
				<img className="w-32" src="logo-bookmark.svg" alt="Bookmark Official Logo" />
			</a>
      <TopNavigation />
		</nav>
    ...
    <div className="md:flex-grow md:flex items-center justify-between dropdown">
      ...
      <nav
        ...
        <ul>
          ...
          <div className="py-10">
            <a href="" className="block rounded text-center ring-2 ring-white py-2 hover:bg-gray-600 font-bold">
              LOGIN
            </a>
          </div>
        </ul>
